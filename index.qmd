...
::: {.callout-warning}
Using AI to write code is the last thing this book will cover, and that is a very intentional. Using AI can superpower your coding but only once you have a solid foundation of knowledge. You need to be able to evaluate what it produces and you need to know what to ask it with enough specificity. Using AI to write code you don't understand is as dangerous as it is irresponsible.
:::
