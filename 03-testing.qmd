...
One of the most valuable skills you can practise with AI is metacognition: thinking about how you are learning as well as what you are learning. Because AI outputs can be wrong, misleading, or poorly targeted, reflecting critically on the quality of the questions is part of the exercise. The process of judging, correcting, and refining AI prompts is itself a way of strengthening your understanding.

The questions AI generates can be helpful, but they are not flawless. Here are the main issues we have encountered while writing this book that could not be fully resolved by prompt tweaking.
