...
You should have a specific week/chapter/lecture of your course in mind to work with. For the PsyTeachR courses, we'll be using the Intended Learning Outcomes, functions used, and glossary to help instruct the AI. If you're not working through a course, or it's not a PsyTeachR course, it would be helpful to have a list of functions, concepts, or skills that you want to test. 

This chapter will involve uploading lecture slides or ILOs to an AI. You should use Copilot through your UofG account or you should ensure that the chat history in ChatGPT is turned off so that the slides are not used to train the model, unless your lecturer has consented to this, it's theft!
...
- All questions should have four responses and one correct answer 
- All questions should align with the intended learning outcomes 
- All questions should be challenging in difficulty.   

> 
- I will upload the learning outcomes and content for the class I want you to test me on. Give me questions one at a time. Ask me for the correct answer and then give me an explanation for each option.
