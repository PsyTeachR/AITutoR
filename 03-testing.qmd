...
-   It will sometimes ask you questions about functions you've haven't covered in the course.
-   It will give you a question where there are multiple correct answers without indicating this is the case, which can be confusing.
...
-   This is the category the AI struggled with the most, to the point where at the time of writing, I can't say that they're up to the task. I have a premium ChatGPT subscription and I also tried using GPT4.0 and it didn't help. I've decided to leave it in, in case it gets better, but also it's a useful cautionary tale of the limits of AI.
...
-   Gemini did poorly at this. I would give me code that did not have errors, or it would tell me what the errors were, or it would give errors that were so obvious they wouldn't help you learn at all. For example:
...
-   ChatGPT also suffered from the same problems as Gemini in that it would tell you what the error was or produce code that did not have any errors. I particularly enjoyed this response whereby it seemed to pretend that it was on purpose as a teachable moment. I know I am anthropomorphising the AI here but I imagine any educator will feel a sense of kinship at trying to make your mistakes seem intentional.
